...
if "%3" == "" (set IN_FILE=..\SampleImages\dog.jpg) else (set IN_FILE=%3)
...
powershell $ProgressPreference = 'SilentlyContinue' ; $hdrs = %AUTH%; Invoke-WebRequest -Verbose -Method POST -Headers $hdrs %URL%?count=1 -InFile %IN_FILE% ^| Select-Object -ExpandProperty RawContent
echo.
